...
- **Cliente novo:** `clientes/<Nome>/` — é a convenção dos perfis freelancer e agência. Nos perfis por tipo (empreendedor solo, empresa, comércio local, profissional liberal, projeto), confirmar com o usuário se ele quer começar a usar `clientes/` agora
