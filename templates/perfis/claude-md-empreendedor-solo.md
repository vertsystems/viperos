...
| E-books, apostilas, guias | `materiais/` | `/documento` |
| Decks | `apresentacoes/` | `/apresentacao` |
...
| Produtos próprios (curso, ebook, oferta) | `produtos/<nome>/` | — |
...
- Conteúdo novo salvar em `conteudo/<tipo>-<tema>-<data>/`
